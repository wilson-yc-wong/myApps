package net.myapp.app.ranking.api;

import net.myapp.app.ranking.api.service.WebVisitCountService;
...
public class ReportRestController {
    ...
    public ResponseEntity<List<Report>> initDatabase() {
        // init DB
        try {
            URI from = this.getClass().getResource("/statistics_data/db_init.csv").toURI();
